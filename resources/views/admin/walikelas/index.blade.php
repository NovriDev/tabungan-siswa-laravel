...
@section('content')
    <h3 class="fw-semibold">Wali Kelas</h3>
    <h6>Menu ini digunakan untuk mencatat dan mengelola data wali kelas</h6>
    <div class="card mt-4">
        <div class="card-body">
            <a href="{{ route('walas.create') }}" class="btn btn-primary mb-4"><i class="ti ti-plus mr-2"></i>Tambah
                Walas</a>
                        ...
                        @foreach ($walikelas as $key => $item)
                            <tr class="align-middle">
                                ...
                                <td class="d-flex">
                                    ...
                                    <form action="{{ route('walas.destroy', $item->id) }}" method="POST"
